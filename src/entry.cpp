    ...
    namespace
    {
            ...
            : public dci::host::module::Manifest
        {
            Manifest()
            {
                ...
                pushServiceId<pql::ExpressionEvaluator4Tests>();
            }
        } manifest_;
            ...
            : public dci::host::module::Entry
        {
            ...
            {
                if(auto s = tryCreateService<Factory>(ilid)) return cmt::readyFuture(s);
                if(auto s = tryCreateService<ExpressionEvaluator4Tests>(ilid)) return cmt::readyFuture(s);
...
extern "C"
{
    DCI_INTEGRATION_APIDECL_EXPORT dci::host::module::Entry* dciModuleEntry = &dci::module::ppn::node::rdb::entry_;
}
